 ...
 * read readme for informatin about missing 1.2
 */
...
public class Missisippi
{
    ...
    public static void newline() { //blank line
        System.out.println();
    }

    public static void doubleS() { // two S's seperated by a blank line
        S();
        newline();
        S();
    }

    public static void doubleP() { // two P's seperated by a blank line
        P();
        newline();
        P();
    }
